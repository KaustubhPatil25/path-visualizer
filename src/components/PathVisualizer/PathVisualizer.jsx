        ...
        <div className="visualizer-wrapper">
          <div className="grid-section">
            <div className="grid-header">
              <span className="grid-label">Grid · 20×40</span>
              <div className="grid-divider" />
              <div className="legend-row">
                <div className="legend-item"><div className="legend-dot start" /><span>Start</span></div>
                <div className="legend-item"><div className="legend-dot finish" /><span>Target</span></div>
                <div className="legend-item"><div className="legend-dot wall" /><span>Wall</span></div>
                <div className="legend-item"><div className="legend-dot visited" /><span>Visited</span></div>
                <div className="legend-item"><div className="legend-dot path" /><span>Shortest Path</span></div>
              </div>
            </div>
